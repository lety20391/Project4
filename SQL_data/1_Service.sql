...
('1993-10-20','andrewgoodall@gmail.com','Andy',1,'0909090907'),
('1993-10-20','tranphanynhi@gmail.com','SuuNhi',1,'0909090906')
...
GO
Insert into dbo.tbPet ([petGender]  ,[petDating] ,[petBreed], [petDOB], [petImage], [petName], [petPrice], [petStatus], [userID], [petStory]) values
('Male', 1,'Cardigan Welsh Corgi', '2017-1-1', 'null', 'Foxi', 120, 1, 1, 'The Cardigan Welsh Corgi is the older of the two Corgi dog breeds, with dogs of this type believed to have existed in Wales for more than 3,000 years. The Cardigan is distinguished by his long tail — like the sleeves of a cardigan sweater — and was used to drive cattle to market. Known as the yard-long dog, the Cardigan is sensible and affectionate. He loves to spend time with his family and is an active, fun-loving playmate for school-age children. The Cardigan’s medium-length coat comes in many colors and patterns, including red, brindle, blue merle and black, usually with white markings.'),
('Female', 0,'Bolognese', '2016-1-1', 'null', 'Snow', 20, 1, 1, 'the Bolognese dog breed loves to be at his family’s side. However, he also loves getting his way and can be quite crafty about it, so be careful — you could find yourself being manipulated by a 10-pound furball.'),
('Male', 1,'Boxer', '2015-1-1', 'null', 'Cau Vang', 15, 1, 2, 'Boxers were originally bred to be medium-size guard dogs. Today, although they are a part of the AKC’s Working Group, they mostly find homes as loving family companions.'),
('Male', 1,'Chinook', '2014-1-1', 'null', 'Kiki', 19, 1, 3, 'Created in the White Mountains of New Hampshire, the Chinook dog breed made his name on Admiral Byrd’s first Antarctic expedition in 1928. These days he’s a multipurpose dog who’s happy hiking, competing in agility and other dog sports, pulling a sled or other conveyance, and playing with the kids.'),
('Female', 1,'Japanese Chin', '2013-1-1', 'null', 'Mina', 19, 1, 2, 'The Japanese Chin dog breed hails from Asia, where he has been prized as a companion for more than a thousand years. He was a popular member of Chinese and Japanese imperial courts, and it was in Japan that his distinctive look was developed. This breed is elegant and dainty, mild-mannered and playful.'),
('Female', 1,'Pembroke Welsh Corgi', '2012-1-1', 'null', 'Cuteo', 19, 1, 2, 'Originally bred to herd cattle, sheep, and horses, the Pembroke Welsh Corgi is an active and intelligent dog breed. Easy to train and eager to learn, Pembrokes are great with children and other pets, and you can find them in four different coat colors and markings.'),
('Male', 1,'Poodle', '2011-1-1', 'null', 'Longlegs', 19, 1, 3, 'Elegant. Proud. Clever. Poodles are impressive dogs, as the many best-in-show winners from this dog breed can attest. Behind the blue ribbons, impressive hairdos, and regal attitude, you’ll find an affectionate family dog with an ancient history and many talents.'),
